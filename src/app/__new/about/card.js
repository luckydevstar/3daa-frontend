            ...
            <div className="mt-[70px] grid grid-cols-1 gap-5 lg:grid-cols-2 lg:items-center">
              ...
              <div className="mt-4">
                ...
                <p className="mt-4 text-xs text-base text-black">
                  The 3D Architectural Academy card serves as proof that
                  individuals are members of the 3DAA Community. It verifies
                  skills, software and digital badges earned, and offers a way
                  to view progress and portfolio. Members can showcase
                  achievements, access exclusive events, and stand out
                  professionally.
                </p>
                <button
