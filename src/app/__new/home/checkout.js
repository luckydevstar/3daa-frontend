...
const CARD_DATA = [
  { frontImage: Card1Image, backImage: Card1Image, title: "Still Renders",     subtitle: "Training Programme", logo: LogoImage, isComingSoon: false },
  { frontImage: Card2Image, backImage: Card2Image, title: "360 Virtual Tours",  subtitle: "Training Programme", logo: LogoImage, isComingSoon: true  },
  { frontImage: Card3Image, backImage: Card3Image, title: "Flythroughs",        subtitle: "Training Programme", logo: LogoImage, isComingSoon: true  },
  { frontImage: Card4Image, backImage: Card4Image, title: "Simulations",        subtitle: "Training Programme", logo: LogoImage, isComingSoon: true  },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-10 sm:pb-12">
      ...
      <div className="flex flex-col gap-2 sm:gap-3 justify-center items-center mb-10 sm:mb-16">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center">Check Out</h2>
