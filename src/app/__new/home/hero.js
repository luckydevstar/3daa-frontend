...
const HomeHero = () => {
  ...
  const line1 = "font-black text-black leading-none !text-[clamp(18px,5.6vw,42px)] my-4";
  const line2 = "font-black text-[#488AFF] leading-none !text-[clamp(20px,6.6vw,50px)] my-4";
  const brand = "!text-[clamp(22px,7.2vw,60px)]";
  const line3 = "font-black text-[#488AFF] leading-none !text-[clamp(18px,5.6vw,42px)] my-4";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="py-6 sm:py-16">
        <Slider {...sliderSettings}>
          ...
          <Slide>
            <h3 className={`${line1} whitespace-nowrap`}>Sign up to</h3>
            <h3 className={`${line2} whitespace-nowrap`}>join the 3DAA community</h3>
            <h3 className={`${line3} whitespace-nowrap`}>this September</h3>
          </Slide>
