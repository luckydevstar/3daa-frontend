  ...
  return (
    <div className="relative flex justify-between items-end w-full overflow-hidden pt-2 mb-12">
      ...
      <div className="pointer-events-none">
        ...
        <img className="w-72 h-auto object-contain rounded-xl -mt-[200px] z-10 ml-[280px]" src={Image5} />
      ...
      <div className="absolute left-1/2 -translate-x-1/2 bottom-0 z-40 flex items-end justify-center">
        ...
        <img className="min-w-40 w-40 sm:w-52 md:w-60 h-auto max-w-none" src={ImageLogo} alt="3DAA" />
      </div>

      {/* Right stack */}
      <div className="pointer-events-none">
        <img className="w-[180px] h-auto object-contain rounded-xl -ml-[40px] z-30 relative" src={Image3} />
        <img className="w-[320px] h-auto object-contain rounded-xl -mt-[120px] z-20 relative ml-[230px]" src={Image2} />
