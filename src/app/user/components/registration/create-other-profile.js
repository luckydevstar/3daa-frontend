...
class CreateOtherProfile extends React.Component {
  render() {
    const {
      user,
      formData,
...
CreateOtherProfile.propTypes = {
  onRegisterStep: PropTypes.func,
  sendingRequest: PropTypes.bool
};

CreateOtherProfile.defaultProps = {
  onRegisterStep: noop,
...
const CreateOtherProfileForm = reduxForm({
  form: FORM_NAME,
  validate
})(CreateOtherProfile);
