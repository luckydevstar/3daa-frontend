...
class CreateInvitationPersonalProfile extends React.Component {
  render() {
    const {
      user,
      handleSubmit,
...
CreateInvitationPersonalProfile.propTypes = {
  onRegisterStep: PropTypes.func,
  sendingRequest: PropTypes.bool
};

CreateInvitationPersonalProfile.defaultProps = {
  onRegisterStep: noop,
...
const validate = values => {
  ...
  // FormUtil.validate(values, errors, 'password').passwordLength().required();
