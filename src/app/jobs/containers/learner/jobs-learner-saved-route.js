...
class JobsLearnerSavedRoute extends Component {
  constructor() {
    super();
    this.state = {
      viewerVisible: false,
  ...
  starClick(job_id) {
    const { unsaveLearnerJob } = this.props;
...
const mapDispatchToProps = dispatch => ({
  ...
  unsaveLearnerJob: job_id => dispatch(Creators.unsaveLearnerJobAttempt(job_id))
});
