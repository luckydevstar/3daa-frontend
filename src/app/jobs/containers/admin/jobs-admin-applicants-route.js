...
class JobsAdminApplicantsRoute extends Component {
  constructor(props) {
    super(props);
    ...
    this.setSelectedApplication = this.setSelectedApplication.bind(this);
    this.changeMessage = this.changeMessage.bind(this);
    this.declineApplication = this.declineApplication.bind(this);
    this.interviewApplication = this.interviewApplication.bind(this);
        ...
        >
          <JobsAdminInterview
            {...{
              ...
              interviewApplication: this.interviewApplication,
              selectedApplication
            }}
          />
        </ContentModal>
...
const mapStateToProps = ({ job, profile, form }) => ({
  job,
  profile,
  form
});
