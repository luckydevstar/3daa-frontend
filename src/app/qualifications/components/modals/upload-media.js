    ...
    if (this.state.file.type.indexOf('svg') === -1) {
      if (this.state.file && this.state.file.type.indexOf('image') !== -1) {
        if (
          ...
          return callback(
            null,
            `Image is to big, max ${this.props.image_max_resolution.width}x${
              this.props.image_max_resolution.height
            }`
          );
        }
        if (
          ...
          return callback(
            null,
            `Image is to small, min ${this.props.image_min_resolution.width}x${
              this.props.image_min_resolution.height
            }`
          );
        }
      }
