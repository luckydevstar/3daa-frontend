const config = {
  api: {
    ...
    API_URL_TEST: 'https://ncs.testing.api.dqual.co.uk/api',
    API_URL_DEV: 'https://ncs.testing.api.dqual.co.uk/api',
    API_URL_STAGING: 'https://ncs.testing.api.dqual.co.uk/api'
  },
  ...
  title: 'NCS',
  fulTitle: 'NATIONAL CITIZEN SERVICE',
  logoDesc: ' ',
