const config = {
  ...
  // },
  api: {
    API_URL_PROD: 'https://api.testing.3darchitecturalacademy.com/api',
    API_URL_TEST: 'https://api.testing.3darchitecturalacademy.com/api',
    API_URL_DEV: 'https://api.testing.3darchitecturalacademy.com/api',
    API_URL_STAGING: 'https://api.testing.3darchitecturalacademy.com/api',
  },
  ...
  website: '3darchitecturalacademy.com',
  tempBadge: 'Level 3',
  registrationFlow: '2',
