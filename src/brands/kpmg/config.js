const config = {
  api: {
    ...
    API_URL_TEST: 'https://kpmg.testing.api.dqual.co.uk/api',
    API_URL_DEV: 'https://kpmg.testing.api.dqual.co.uk/api',
    API_URL_STAGING: 'https://kpmg.staging.api.dqual.co.uk/api'
  },
