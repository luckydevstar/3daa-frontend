const config = {
  api: {
    ...
    API_URL_TEST: 'https://proto.testing.api.dqual.co.uk/api',
    API_URL_DEV: 'https://proto.testing.api.dqual.co.uk/api',
    API_URL_STAGING: 'https://proto.testing.api.dqual.co.uk/api'
  },
