const config = {
  api: {
    ...
    API_URL_TEST: 'https://ws.testing.api.dqual.co.uk/api',
    API_URL_DEV: 'https://ws.testing.api.dqual.co.uk/api',
    API_URL_STAGING: 'https://ws.testing.api.dqual.co.uk/api'
  },
  ...
  title: 'worldskills',
  fulTitle: 'worldskills',
  logoDesc: 'worldskills | Platform One',
