const config = {
  api: {
    ...
    API_URL_TEST: 'https://ncfe.testing.api.dqual.co.uk/api',
    API_URL_DEV: 'https://ncfe.testing.api.dqual.co.uk/api',
    API_URL_STAGING: 'https://ncfe.staging.api.dqual.co.uk/api'
  },
